...
/**
 * Report a renderer-side error to the server diagnostic log.
 * Fire-and-forget reporting must never interrupt the UI.
 *
 * Only the message, stack, and a small structured `context` are sent. Never
 * pass transcript text, clipboard content, or other sensitive data as context.
 */
